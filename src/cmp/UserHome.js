          ...
          <div id="about" className="aboutus" style={{ width: "60vw" }}>
            <div className="d-flex justify-content-between mt-3">
              ...
              <div className="mx-3">
                ...
                <p>
                  At Achiever Solutions we are dedicated to empowering
                  individuals with the knowledge and skills needed to excel in
                  the dynamic world of technology. We take pride in being a
                  leading computer institute that offers comprehensive and
                  industry-relevant courses to students of all ages and
                  backgrounds.
                </p>
                <h3>Our Vision</h3>
                <p>
